...
For movement instructions, the rule encodes integer arithmetic, other than xcor and ycor for heading multiples of 15 degrees by consulting the precomputed trigonometric table in \texttt{optimization\_helpers.py}, avoiding floating-point imprecision in the symbolic encoding.
