...
\node[draw=creambox, align=left, fill=none, anchor=north, text width=8.75cm, inner sep=6pt] (ex1) at (0,0) {{\ttfamily
if :u > 0 [\\
\hspace*{1.2em}:t = 30\\
] else [\\
\hspace*{1.2em}:t = 45\\
...
\begin{minipage}[t]{0.48\linewidth}
\centering
\begin{tikzpicture}[>=stealth, line width=0.5pt, font=\small]
\tikzset{
